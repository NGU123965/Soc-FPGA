...
HD_PWD='D:/Projects/Vivado/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2I2Cphase1summer2021ZMJ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2I2Cphase1summer2021ZMJ.tcl
