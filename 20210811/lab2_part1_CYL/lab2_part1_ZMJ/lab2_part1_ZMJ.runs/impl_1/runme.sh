...
HD_PWD='D:/Projects/Vivado/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2I2Cphase1summer2021ZMJ.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2I2Cphase1summer2021ZMJ.tcl -notrace
