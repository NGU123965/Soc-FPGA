...
HD_PWD='C:/Xilinx/SHCodesign2021/detect011versions/detect011versions.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log detect011Expressions.vds -m64 -mode batch -messageDb vivado.pb -notrace -source detect011Expressions.tcl
