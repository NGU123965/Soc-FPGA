...
HD_PWD='C:/Xilinx/SHCodesign2021/TransmitRAM2021summer/TransmitRAM2021summer.runs/ClockGenerator50MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockGenerator50MHz.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ClockGenerator50MHz.tcl
