...
#
# Generated by export_simulation on Wed Aug 11 17:12:39 -0400 2021
#
################################################################################
...
switch to the './ClockGenerator50MHz.sh' script.

./ClockGenerator50MHz.sh -reset_run
...
./ClockGenerator50MHz.sh -noclean_files

For more information on the script, please type './ClockGenerator50MHz.sh -help'.
