...
HD_PWD='C:/Xilinx/SHCodesign2021/lab2summer2021HUST_I2C/UartTyperwriter2021summer/UartTyperwriter2021summer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UartTyperwriter2021summer.vdi -applog -m64 -messageDb vivado.pb -mode batch -source UartTyperwriter2021summer.tcl -notrace
