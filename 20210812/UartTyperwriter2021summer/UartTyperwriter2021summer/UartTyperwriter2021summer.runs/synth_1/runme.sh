...
HD_PWD='C:/Xilinx/SHCodesign2021/lab2summer2021HUST_I2C/UartTyperwriter2021summer/UartTyperwriter2021summer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UartTyperwriter2021summer.vds -m64 -mode batch -messageDb vivado.pb -notrace -source UartTyperwriter2021summer.tcl
