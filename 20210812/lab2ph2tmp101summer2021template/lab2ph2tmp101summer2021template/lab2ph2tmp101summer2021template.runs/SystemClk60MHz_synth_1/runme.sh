...
HD_PWD='C:/Xilinx/SHCodesign2021/lab2summer2021HUST_I2C/lab2ph2tmp101summer2021template/lab2ph2tmp101summer2021template.runs/SystemClk60MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemClk60MHz.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SystemClk60MHz.tcl
