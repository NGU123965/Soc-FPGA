...
#
# Generated by export_simulation on Wed Aug 11 20:37:14 -0400 2021
#
################################################################################
...
switch to the './SystemClk60MHz.sh' script.

./SystemClk60MHz.sh -reset_run
...
./SystemClk60MHz.sh -noclean_files

For more information on the script, please type './SystemClk60MHz.sh -help'.
